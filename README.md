...
* [Написание курсовой работы (Шаблон)](#написание-курсовой-работы)
...
* [Автонумерация](#автонумерация) рисунков, таблиц, листингов, источников, разделов с возможностью ссылаться на них
* [Вставка содержимого других](#вставка-другого-docx) DOCX-файлов с заменой текста (например, титульник с заменой темы)
* Вставка специфичных элементов отчёта по курсовой работе
* Автоматическое добавление "Продолжение таблицы #" при разрыве таблицы на несколько страниц
...
* Экспорт в PDF
* Автоматическое добавление "Продолжение таблицы #" и "Продолжение листинга #"
...
* В VSCode можно вставлять картинки в md прямо из буфера обмена
	* Также можно указать, куда будет сохраняться картинка, добавив в настройки (`Ctrl+Shift+P >Open User Settings (JSON)`) следующие строки:
		...
		```
* Включите [ленивую автонумерацию](#настройки-автонумерации)
