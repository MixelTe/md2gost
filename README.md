...
* Включить нумерацию по разделам: `!!rule numbering sections on`
...
Если документ вставляется не в начало файла, то добавьте второй `!!section` ещё и до вставки документа.
