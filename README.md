...
Расширение для преобразования Markdown-файлов в **DOCX** и **PDF** с автоматическим соблюдением требований ГОСТ (курсовые, отчёты, дипломы). *Автор не в силах гарантировать 100% соблюдение ГОСТ*
...
* `!!(title.docx){}` – вставляет титульный лист (только при экспорте в PDF)
* `!!section from 2` – начинает нумерацию страниц с 2 (после титульника)
* `[#]` – автоматически подставляет номер рисунка
