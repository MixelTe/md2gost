...
2. **Секции:** [Команда](#разрыв-секции) `!!section from 3` позволяет начать нумерацию страниц с нужного числа (обычно с реферата), пропустив [титульный лист](#вставка-внешнего-документа) и задание.
...
* `!!section` – начинает новую страницу и **сбрасывает нумерацию**. Подробнее в разделе [Работа с секциями](#разрыв-секции).
